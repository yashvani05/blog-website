            ...
            <div className="max-w-4xl mx-auto bg-white p-8 rounded-lg shadow-lg">
                ...
                <div className="mt-8">
                    ...
                    <p className="mt-4 text-gray-600">
                        Hello, I'm Yash Vani. I'm a passionate web developer with a love for creating beautiful and functional websites.
                        I specialize in front-end development, using modern technologies like React and Tailwind CSS. When I'm not coding,
                        you can find me exploring new tech trends or writing blogs about my experiences and learnings.
                    </p>
                </div>
            </div>
        </div>
